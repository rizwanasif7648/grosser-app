...
RSpec.describe '/roles', type: :request do
  ...
  let(:valid_attributes) do
    { title: 'test role', status: 'active', customer_id: 1 }
  end

  let(:invalid_attributes) do
    { title: nil, customer_id: nil }
  end
  ...
  describe 'GET /new' do
    it 'renders a successful response' do
      @role_permission = FactoryBot.create(:role_permission)
      assign(:role_permissions, [@role_permission])
      get new_role_url
      expect(response).to be_successful
    end
  end
