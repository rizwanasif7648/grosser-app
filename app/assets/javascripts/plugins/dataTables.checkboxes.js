 ...
 * @github      https://github.com/gyrocode/jquery-datatables-checkboxes
 * @example     https://jsfiddle.net/snqw56dw/3182/
...
(function( factory ){
      ...
      for(var i = 0; i < ctx.aoColumns.length; i++){
        if (ctx.aoColumns[i].checkboxes){
          ...
          if(ctx.aoColumns[i].sClass === ''){
            colOptions['className'] = 'dt-checkboxes-cell custom-control custom-checkbox d-table-cell';
          } else {
            colOptions['className'] = ctx.aoColumns[i].sClass + ' dt-checkboxes-cell custom-control custom-checkbox d-table-cell';
          }
          ...
          if(ctx.aoColumns[i].mRender === null){
            colOptions['render'] = function(){
              ...
              return '<input type="checkbox" class="custom-control-input dt-checkboxes" id="customCheck" name="example1">\n' +
  ...
  Checkboxes.defaults = {
    ...
    selectAllRender: '            <input type="checkbox" class="custom-control-input" id="customCheck" name="example1">\n' +
      '            <label class="custom-control-label" for="customCheck"></label>'
  };
